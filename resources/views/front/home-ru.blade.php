    ...
    <section id="courses" class="courses text-decoration-none">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Консультации в режиме онлайн</h2>
                <p>Консультации в режиме онлайн предназначены для новичков или для людей, которым нужна помощь с настройками, установкой программного обеспечения или индивидуальная консультация. Все консультации сопровождаются видеозаписью.</p>
            </div>
